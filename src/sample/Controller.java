...
//	
	 ...
	 * si le container n'est pas null et qu'il contient un objet de classe assiette, que cette assiette a pour �tat PLAT, alors 
	 * on v�rifie qu'il y a bien un client qui attend et cette assiette lui est distribu� en cliquant sur lui.
	 * Le client v�rifie que les ingredients dans l'assiette correspondent � sa commande, le score augmente en fonction, et il s'en va.
	 * L'assiette passe en �tat SALE.
	 * Si le container est null et qu'il y a une assiette dans l'emplacement du client, en cliquant sur le client, on r�cupere l'assiette SALE
	 * @param e
	 */
